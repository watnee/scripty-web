...
(function () {
    ...
    function init() {
        // The project list renders as a card <ul> (#project-list-cards); each
        // card carries .project-list-row, the same hook the search filter uses.
        var table = document.getElementById('project-list-cards');
        ...
        function visibleCheckboxes() {
            return Array.prototype.slice
                ...
                .filter(function (cb) {
                    ...
                    // project-search.js hides filtered-out cards with
                    // style.display = 'none'; a hidden card is not "all".
