    ...
    function getActiveBlockId(triggerEl) {
        ...
        function isFormatChrome(el) {
            return !!(el && el.closest && el.closest(
                '.bulk-type-btn, .bulk-align-btn, .bulk-style-btn, .text-format-toolbar-btn, ' +
                '.text-format-dropdown, .text-format-actions, .element-type-actions, .project-script-toolbar'
            ));
        }
